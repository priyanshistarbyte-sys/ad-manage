    ...
    <div class="dash-header" style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;justify-content:space-between;margin-bottom:16px">
        <div>
            ...
            <div class="dash-subtitle" style="color:var(--text-muted);font-size:12.5px">
                @if ($singleDate)
                    {{ \Carbon\Carbon::parse($singleDate)->format('d M Y') }}
                @else
        ...
        <div class="d-flex gap-2">
            <a href="{{ url('/report?' . $q()) }}" class="btn-sm-custom" style="text-decoration:none;color:var(--text-muted);align-self:center">
            ...
            <table class="ledger monthly" style="width:100%;white-space:nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($c->geo_id)
                            <a href="{{ url('/report?' . $q(['geo_id' => $c->geo_id])) }}" class="pill" style="text-decoration:none">DRILL IN</a>
                            @endif
                        </td>
                    </tr>
                    @empty
